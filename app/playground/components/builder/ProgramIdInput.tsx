  ...
  return (
    <div>
      <div className="mb-1.5 flex items-center justify-between">
        <label htmlFor="program-id" className="text-sm font-medium text-foreground">
          Program ID
        </label>
        <div className="flex gap-1.5 flex-wrap justify-end">
          {PRESETS.map((preset) => (
            <div key={preset.id} className="relative">
              ...
              {hoveredId === preset.id && (
                <div className="pointer-events-none absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 w-52 rounded-md bg-foreground px-2.5 py-1.5 text-[11px] leading-snug text-background shadow-lg">
                  {preset.description}
